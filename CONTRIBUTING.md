...
1. `go get github.com/28reasons/grpc-gateway/protoc-gen-grpc-gateway`
2. `cd $GOPATH/src/github.com/28reasons/grpc-gateway`
3. hack, hack, hack...
...
```bash
$ docker run -v $(pwd):/go/src/github.com/28reasons/grpc-gateway --rm jfbrandhorst/grpc-gateway-build-env \
    /bin/bash -c 'cd /go/src/github.com/28reasons/grpc-gateway && \
        make realclean && \
